...
# django can integrate with existing database with help of inspectdb command.
'''
00. Integrating Django with a legacy database¶
----------------------------------------------
While Django is best suited for developing new applications, it’s quite possible to integrate it into legacy databases. Django includes a couple of 
...
01. Give Django your database parameters¶
--------------------------------------------
...
setting and assigning values to the following keys for the 'default' connection:
...
By default, inspectdb creates unmanaged models. That is, managed = False in the model’s Meta class tells Django not to manage each table’s creation,
...
03. Install the core Django tables¶
-------------------------------------
...
Test and tweak¶
Those are the basic steps – from here you’ll want to tweak the models Django generated until they work the way you’d like. Try accessing your data via the Django database API, 
and try editing objects via Django’s admin site, and edit the models file accordingly.
'''
